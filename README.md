...
- Phase 3 已实现 IndexedDB 保存、Library、JSON 导入导出、MIDI 导出。
- Phase 3 尚未实现录音与 `POST /api/transcribe`。
- Phase 3 尚未接入 Basic Pitch。
- Phase 3 的 Editor 仍使用 mock transcription fixture。
